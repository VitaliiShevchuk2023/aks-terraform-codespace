...
Deploy an AKS cluster using Terraform in GitHub Codespaces. Includes a multi-container retail store demo app with Store Front, Product Service, Order Service, and RabbitMQ.
